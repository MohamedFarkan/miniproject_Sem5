...
<body>
    <div class="container">
        ...
        <hr />
        <div class="simple">
            <img src="port_img/collections of  0 (1).png" alt="" class="im1" />
            <div class="cont">
                <h1>Wellcome! Here,</h1>
                <p>
    ...
    <div id="services">
        <div class="container">
            ...
            <div class="service-list">
                <div class="wedd">
                    <h2>
                        Wedding Photography <img src="port_img/rings.png" class="im2" />
                    </h2>
                    <p>
                ...
                <div class="nature">
                    <h2>
                        Nature photography
                        <img src="port_img/planet-earth.png" class="im2" />
                    </h2>
                    <p>
                ...
                <div class="tour">
                    <h2>
                        Tourism photography <img src="port_img/tourism.png" class="im2" />
                    </h2>
                    <p>
        ...
        <div class="container">
            <div class="sub-title">
                ...
                <div class="work">
                    <div class="work-list">
                        <div class="a1">
                            <img src="port_img/nature-3082832_1280.jpg" alt="" />
                        </div>
                        <div class="txt">
                            <p class="tx1">
                    ...
                    <div class="work-list">
                        <div class="a2">
                            <img src="port_img/butterflies-1127666_1280.jpg" alt="" />
                        </div>
                        <div class="txt">
                            <p class="tx2">
                    ...
                    <div class="work-list">
                        <div class="a3">
                            <img src="port_img/dandelion-445228_1280.jpg" alt="" />
                        </div>
                        <div class="txt">
                            <p class="tx3">
